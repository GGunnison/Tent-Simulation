function [uz, ug] = MILP(Z, G, n, t, I, Qz, Efan, etaz, Pg, Fg, Rz, Cz, kz, Tll, Tul, T_o, rho_temp, plt )
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Grant Gunnison
%
...
%% Inputs
%  Parameters
% %  Z                            %  Number of tents (1 heater per tent)  (-)
% %  G                            %  Number of generators                 (-)
% %  n                            %  Planning horizon                     (s)
% %  t                            %  Time interval of planning horizon    (s)
% %  I                            %  Number of time intervals             (-)
% %  rho_temp                     %  Penalty for temperative violation    (W)
...
Tll  = (Tll + 273.15)*ones(I,Z);%  Lower temperature limit of tent z    (K)
Tul  = (Tul+273.15)*ones(I,Z);  %  Upper temperature limit of tent z    (K)
T_o  = (T_o+ 273.15)*ones(1,Z); %  Initial temperature of tent z        (K)
